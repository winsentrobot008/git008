...
/**
 * CalorieBestiePanel - the intake half of the CALauraAI dual-bestie loop.
 *
 *   photo -> POST /api/calaura/recognize -> FoodScanEvent on the shared bus
 ...
 * 008AI CALauraAI Bundle modal. There is no mock fallback: when the bridge route
...
import SculptBalanceCard from "@/components/calaura/SculptBalanceCard";
import BestieNoteCard from "@/components/calaura/BestieNoteCard";
import BestieHandoffCard from "@/components/calaura/BestieHandoffCard";
import PaywallModal from "@/components/calaura/PaywallModal";
import { balanceBriefingLine, computeBalance } from "@/lib/calaura/balance";
import { FREE_FOOD_SCANS, MAX_IMAGE_BYTES } from "@/lib/calaura/config";
