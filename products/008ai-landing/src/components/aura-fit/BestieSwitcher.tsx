...
/**
 * BestieSwitcher - the two-bestie selector of the merged Aura Fit app.
 *
...
import { BESTIE_LIST, type Bestie, type BestieId } from "@/lib/aura-fit/besties";
...
export default function BestieSwitcher({ activeId, onSelect, disabled }: BestieSwitcherProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-2" role="radiogroup" aria-label={t("aura.switcherLabel")}>
