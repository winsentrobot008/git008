#!/usr/bin/env python3
"""
task_listener.py — AI-WORKFLOW Task Listener (Phase 5)
...
def process_github_issue(issue: dict) -> bool:
    ...
    try:
        ...
        comment_parts.append(f"")
        comment_parts.append(f"---")
        comment_parts.append(f"*由 AI-WORKFLOW Factory OS v0.5.0-crossplane 自动执行*")
...
def main():
    print("[task_listener] AI-WORKFLOW Task Listener (Phase 5.1+ Anti-Freeze Subprocess)")
