#!/usr/bin/env python3
"""
api_gateway.py — AI-WORKFLOW HTTP API Gateway (Phase 3 + Web Integration)
...
class ManekiAPIHandler(BaseHTTPRequestHandler):
    """HTTP request handler for the AI-WORKFLOW API Gateway."""
...
def run_server(host="0.0.0.0", port=DEFAULT_PORT):
    ...
    print(f"[api_gateway] AI-WORKFLOW API Gateway starting...")
