# AI-WORKFLOW Web Frontend Architecture

## Overview

The AI-WORKFLOW web frontend is a **single-file Streamlit application** (`app.py`) deployed on **Render** at `https://maneki-ai.onrender.com/`. It provides a task management console that interfaces with the internal AI-WORKFLOW Smart Factory pipeline via the API Gateway.
...
- **Service**: `AI-WORKFLOW` (Python web service)
