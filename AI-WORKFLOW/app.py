...
app = FastAPI(title="AI-WORKFLOW Factory", lifespan=lifespan)
...
<head>
    ...
    <title>AI-WORKFLOW Factory Console</title>
...
<body>
    <div class="factory-home">
        <div class="factory-card">
            ...
            <h1 class="factory-title">AI-WORKFLOW Factory Console</h1>
            ...
            <div class="factory-footer">
                ...
                &nbsp;·&nbsp;
                <a href="https://github.com/winsentrobot008/Maneki-AI" target="_blank">AI-WORKFLOW v0.5.0-factory</a>
                &nbsp;·&nbsp; AI Factory OS
            </div>
        </div>
    </div>
...
<html><head><title>AI-WORKFLOW Live</title></head>
<body style="background:#0d1117;color:#c9d1d9;font-family:monospace;padding:40px;text-align:center">
<h1>🏭 AI-WORKFLOW Live Factory</h1>
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        await websocket.send_json({
            "type": "connected",
            "message": "✅ 已连接到 AI-WORKFLOW 工厂实时流",
            "version": "v0.5.0-factory",
