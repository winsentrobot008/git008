"""
AI-WORKFLOW Factory Dashboard — Streamlit UI (v0.6.0-factory)
...
def main():
    ...
    st.markdown(
        ...
        "AI-WORKFLOW Factory Dashboard v0.6.0-factory · Powered by Streamlit · "
