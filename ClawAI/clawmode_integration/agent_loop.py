"""
ClawAIAgentLoop — subclasses nanobot's AgentLoop to add:

1. ClawAI economic tools (decide_activity, submit_work, learn, get_status)
...
class ClawAIAgentLoop(AgentLoop):
    """AgentLoop with ClawAI economic tracking and tools."""

    def __init__(
        self,
        *args: Any,
        clawwork_state: ClawAIState,
        **kwargs: Any,
    ) -> None:
    ...
    def _register_default_tools(self) -> None:
        """Register all nanobot tools plus ClawAI tools."""
