"""
ClawAI tools as nanobot Tool ABC subclasses.
...
Each tool receives a shared ClawAIState dataclass (replaces the
...
@dataclass
class ClawAIState:
    """Mutable state shared across all ClawAI tools within a session."""
...
class DecideActivityTool(Tool):
    ...
    def __init__(self, state: ClawAIState) -> None:
        self._state = state
